        ...
        <div class="mb-28">
            <div class="inline-flex ">
                ...
                <button id="dropdownInformationButton" data-dropdown-toggle="dropdownInformation"
                    ...
                    type="button">
                    <img src="images\italy_flag.png" alt="" class="w-5 h-4 "> <svg class="w-3 h-3  " fill="none"
                ...
                <div id="dropdownInformation"
                    ...
                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                        ...
                        <li>
                            <a href="#"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"><img
                                    src="images\italy_flag.png" alt=""></a>
                        </li>
                        <li>
                            <a href="#"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"><img
            ...
            <div class="inline-flex absolute left-20 mt-10 lg:-mt-[4.5rem] md:left-64  lg:left-[49rem] xl:left-[72rem] ">
                ...
                <a href=""> <img src="images\svg\footer\YoutubeIcon.svg" alt="" class="w-7 h-7 ml-3"></a>
                <a href=""> <img src="images\svg\footer\PinterestIcon.svg" alt="" class="w-7 h-7 ml-3"></a>
